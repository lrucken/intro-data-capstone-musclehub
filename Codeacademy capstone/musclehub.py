...
_,pval1,_,_ = chi2_contingency(app_pivot[['Application', 'No Application']])
...
_,pval2,_,_ = chi2_contingency(member_pivot[['Member', 'Not Member']])
pval2
...
_,pval3,_,_ = chi2_contingency(final_member_pivot[['Member', 'Not Member']])
pval3
...
y_ticks = [0.00,0.05,0.10,0.15]
ax.set_yticks(y_ticks)
ax.set_yticklabels([str(i*100) + '%' for i in y_ticks])
...
ax.set_xticklabels(['Fitness Test', 'No Fitness Test'])
y_ticks = [x * 0.1 for x in range(10)]
ax.set_yticks(y_ticks)
ax.set_yticklabels([str(i*100) + '%' for i in y_ticks])
plt.title('Percent Of Applicants Who Purchase A Membership')
plt.savefig('percent_applicant_purchase.png')
plt.show()
